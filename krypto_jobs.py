...
# YOUR CODE HERE
#I was NOT able to execute this pair of code lines
#TypeError: get_balance() missing 1 required positional argument: 'address'
#ether = get_balance(account.address)
#st.sidebar.write("Account Balance (ETH):", ether)
...
# YOUR CODE HERE
st.sidebar.write(f'Total Wage (ETH): {wage}')
